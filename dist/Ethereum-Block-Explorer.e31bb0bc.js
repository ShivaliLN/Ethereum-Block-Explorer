...
var INFURA_ENDPOINT = "https://mainnet.infura.io/v3/e9f53f58de45418da8224a86b51092f9"; // <-- insert your Infura Endpoint

document.getElementById("latestBlock").addEventListener('click', function () {
...
document.getElementById("block").addEventListener('click', function () {
  axios.post(INFURA_ENDPOINT, {
    ...
    var block = response.data.result;
    var returnData = "Block Height: " + parseInt(block.number) + "<br><br>" + "Timestamp: " + block.timestamp + "<br><br>" + "Number of Transactions: " + parseInt(block.transactions.length) + "<br><br>" + "Mined By : " + block.miner + "<br><br>" + "Difficulty : " + parseInt(block.difficulty) + "<br><br>" + "Total Difficulty : " + parseInt(block.totalDifficulty) + "<br><br>" + "Size : " + parseInt(block.size) + " bytes" + "<br><br>" + "Gas Used : " + parseInt(block.gasUsed) + " (" + (block.gasUsed / block.gasLimit * 100).toFixed(2) + ")%" + "<br><br>" + "Gas Limit : " + parseInt(block.gasLimit) + "<br><br>" + "Nonce :  " + block.nonce;
...
document.getElementById("addressSearch").addEventListener('click', function () {
  var addrs = document.getElementById("exchange-address").value;
  axios.post(INFURA_ENDPOINT, {
    "jsonrpc": "2.0",
    ...
    document.getElementById("addressBalance").innerHTML = parseInt(response.data.result) / Math.pow(10, 18) + " Ether";
  });
});
},{"./index.scss":"index.scss","axios":"node_modules/axios/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Ethereum-Block-Explorer.e31bb0bc.js.map